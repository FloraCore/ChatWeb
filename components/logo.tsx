export default function Logo(color: LogoProps) {
    return (
        <>
            <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" id="mx_n_1685809311937" width="32" height="32" style={{position: "relative", top: 10}}>
                <path
